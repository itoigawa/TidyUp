...
<div class="weather-box">
  ...
  <template v-if="condition.main == 'Rain'">
    <v-img src="assets/rain.jpg" width="600" height="400">
      <div class="weather-info">
        <p class="weather-city">Tokyo</p>
        <p class="weather-condition">Sunset</p>
        <p class="weather-temp">22&deg;C</p>
      </div>
    </v-img>
  </template>
  <template v-else-if="condition.main == 'Clouds'">
    <v-img src="assets/cloudy.jpg" width="600" height="400">
      <div class="weather-info">
        <p class="weather-city">Tokyo</p>
        <p class="weather-condition">Sunset</p>
        <p class="weather-temp">22&deg;C</p>
  ...
  <template v-else-if="condition.main == 'Clear'">
    <v-img src="assets/sunny.jpg" width="600" height="400">
      <div class="weather-info">
        <p class="weather-city">Tokyo</p>
        <p class="weather-condition">Sunset</p>
        <p class="weather-temp">22&deg;C</p>
  ...
  <template v-else>
    <v-img src="assets/sunset.jpg" width="600" height="400">
      <div class="weather-info">
...
//   mounted: function(){
//     axios.get(
//       'https://api.openweathermap.org/data/2.5/weather?q=Tokyo,jp&units=metric&appid=46b4509a90656ba5c8c2ee7a23293910', 
//     {
